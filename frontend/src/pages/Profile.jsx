...
const Profile = () => {
  ...
  // ✅ Decode userId from token (backend stores userId)
  // or store userId in Redux at login time for cleaner logic
  ...
  if (!token) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-center">
        <Navbar />
        <h2 className="text-xl font-semibold mt-8">Please log in to view your profile.</h2>
      </div>
    );
  }
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input value={user?.email} disabled className="rounded-md bg-gray-100" />
                </div>
